...
<html>
    ...
    <header class="header">
        ...
        <div class="formbox2">
            ...
            <form class="f3"  method="POST" action="applyjobsubmit.php" id="form">
                <div class="f4">
...
<html>
    <head>
        <link rel="stylesheet" href="css/slider.css">
        <link rel="stylesheet" href="cssApply/index.css">
        <link rel="stylesheet" href="cssApply/applyjob.css">
        <title>
            Online Job Portal
        </title>
    </head>
    ...
    <header class="header">
            ...
            <div class="nnav">
                <nav>
                    ...
                    <form action="index.html"  class="searchbar"><center>
                    <input type="text" name="" placeholder="Search..." class="container">
                    <button type="submit" class="btn3">Search</button></center>
                    </form>
                </div>
